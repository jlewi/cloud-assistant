  ...
  return (
    <Box className="w-screen h-screen max-w-full overflow-hidden flex flex-col">
      ...
      <Box className="w-full p-3 border-b" style={{ backgroundColor: 'var(--color-panel-solid)' }}>
        <Flex align="center" justify="between">
          <Flex align="center" gap="2">
            ...
            <Text size="5" weight="bold">Cloud Assistant</Text>
          </Flex>
          <Flex gap="4">
            <Flex as="button" className="cursor-pointer" gap="1" align="center">
      ...
      <Flex className="w-full flex-1 gap-4 justify-between overflow-hidden p-4">
        ...
        {/* Middle */}
        <Box className="flex-1 h-full flex flex-col">
          <Text size="5" weight="bold" className="mb-2">Actions</Text>
          <ScrollArea className="h-[calc(100%-40px)] flex-1">
            {middle}
          </ScrollArea>
        </Box>
        ...
        {/* Right */}
        <Box className="flex-1 h-full flex flex-col">
          <Text size="5" weight="bold" className="mb-2">Files</Text>
          <ScrollArea className="h-[calc(100%-40px)] flex-1">
            {right}
          </ScrollArea>
        </Box>
