...
function RunActionButton({ exitCode, handleRunClick }: { exitCode: number | null, handleRunClick: () => void }) {
  return (
    <Button variant="soft" onClick={handleRunClick}>
      ...
      {exitCode !== null && exitCode > 0 && (
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#ef4444" fontSize="14" fontWeight="bold">
            {exitCode}
          </text>
        </svg>
      )}
    ...
    <div>
      <Box className="w-full p-2">
        <div className="flex justify-between items-top">
          <RunActionButton exitCode={exitCode} handleRunClick={handleRunClick} />
